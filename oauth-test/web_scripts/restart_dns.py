...
def restart_dns():
    ...
    subprocess.Popen(["cd /home/ec2-user/cim_proj/HU_Cloud-Infrastructure-and-Management/dns-server/; ", "sudo", INTERPRETER, DNSSERVER], stdout=subprocess.PIPE, shell=True)
